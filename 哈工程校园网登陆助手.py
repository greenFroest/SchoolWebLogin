...
class SchoolWebLogin(QtWidgets.QWidget):
    ...
    def Set_Pushbutton(self):
        self.bt1.move(int(width / 2 - 50), int(height - 100))
        self.bt1.setObjectName('Submit')
        self.bt1.clicked.connect(self.Auto_login)
        self.bt1.setIcon(QtGui.QIcon(":/4.png"))
    ...
    def Set_Labels(self):
        ...
        self.lb_user.move(self.lb_x, height - 220)

        self.lb_pass.setText("密码：")
        self.lb_pass.move(self.lb_x, height - 160)

    # 设置编辑框
    def Set_LineEdit(self):
        self.line_edit_user.move(130, height - 220)
        self.line_edit_pass.move(130, height - 160)
    ...
    def InitUI(self):
        ...
        background.setBrush(self.backgroundRole(), QtGui.QBrush(QtGui.QPixmap(":/3.jpg")))
